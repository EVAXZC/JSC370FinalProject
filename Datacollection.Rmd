...
Homicides_mf<- met_40 %>% 
  ...
  labs(
    title = "The Homicides Value in different countries",
...
Alcohol_mf <- met_40 %>% 
  ...
  labs(
    title = "The Alcohol consumption per capita (liters) in different countries",
    subtitle = 'Year: {frame_time}',
...
doctor_mf <- met_40 %>% 
  ...
  labs(
    title = "Medical doctors in different countries",
    subtitle = 'Year: {frame_time}',
